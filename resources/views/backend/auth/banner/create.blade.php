                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                {{ html()->text('customer_name')
                                    ->class('form-control')
                                    ->placeholder(__('validation.attributes.backend.access.banners.name'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                {{ html()->date('renting_began_at')
                                    ->class('form-control')
                                    ->placeholder(__('validation.attributes.backend.access.banners.renting_began_at'))
                                    ->attribute('maxlength', 191)
                                    ->required() }}
                            </div><!--col-->
                        </div><!--form-group-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                {{ html()->date('renting_ends_at')
                                    ->class('form-control')
                                    ->placeholder(__('validation.attributes.backend.access.banners.renting_ends_at'))
                                    ->attribute('maxlength', 191)
                                    ->required() }}
                            </div><!--col-->
                        </div><!--form-group-->
